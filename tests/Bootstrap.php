 ...
 * @license    http://github.com/padraic/php-cvrf/master/LICENSE New BSD License
 */

/*
 * Set error reporting to the level to which php-cvrf code must comply.
 */
...
if (defined('TESTS_GENERATE_REPORT') && TESTS_GENERATE_REPORT === true &&
    ...
    /*
     * Add php-cvrf library/ directory to the PHPUnit code coverage
